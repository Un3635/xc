<template>
  <div class="page-findpwd">
    <div class="page-findpwd-white">
      <div class="page-findpwd-inner">
        <el-tabs v-model="regType" @tab-click="tabclick">
          <el-tab-pane label="手机号找回" name="0">
            <el-form>
              <el-form-item class="page-findpwd-account">
                <div>
              ...
              <el-form-item class="page-findpwd-code">
                <div>
              ...
              <el-form-item class="page-findpwd-err" v-show="err">
                <div class="page-findpwd-err-content">{{err}}</div>
              </el-form-item>
              <el-form-item>
                <el-button class="page-findpwd-regbtn" @click="sub" :loading="sub_loading" :disabled="!formdata.account||!formdata.pwd||!formdata.pwd1||!formdata.code">修改密码</el-button>
              </el-form-item>
            </el-form>
            <div class="page-findpwd-gologin">
              <!-- <div class="page-findpwd-gologin-up">
                                已经帐号?
                                <a href="">登录</a>
                            </div> -->
              <div class="page-findpwd-gologin-down">同一账号可登录挖链网、TIR、算立方等挖链旗下产品</div>
            </div>

          </el-tab-pane>
          <el-tab-pane label="邮箱找回" name="1">
            <el-form>
              <el-form-item>
                <el-input placeholder="邮箱" v-model="formdata.account" @focus="err=''">
                </el-input>
              </el-form-item>
              <el-form-item class="page-findpwd-code">
                <div>
        ...
        <div id="page-findpwd-captcha"></div>
      </div>
    </div>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      getcode() {
        ...
        wy_captcha({
          el: "#page-findpwd-captcha"
        })
          .then(data =>
            getSendCode(
              {
                account: this.formdata.account,
                type: this.regType * 1 + 21,
      ...
      sub() {
        ...
        var _data = { ...this.formdata, type: this.regType * 1 + 21 };
        if (this.regType == "1") {
          _data.countryNum = "";
        }
        resetPwd(_data, false)
          .then(res => {
            this.$message("密码找回成功");
            setTimeout(() => {
