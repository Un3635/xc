 ...
 * @param {string}        params.desc - 订单备注
 * @param {string|number} params.smsOrderCode - 验证码
 * @param {boolean}       params.submitType - 下单类型 true-购物车下单
 * @param {Array<Object>} params.orderGoodsVos - 商品数量数组
 * @param {string|number} params.orderGoodsVos[].batchGoodsId - 批次商品Id
 * @param {number}        params.orderGoodsVos[].goodsCount - 商品数量
 * @param {Array<Object>} params.orderGoodsVos[].couponInfoVos - 商品使用的优惠券
 * @param {string|number} params.orderGoodsVos[].couponInfoVos[].couponInfoId - 优惠券Id
 * @param {string|number} params.orderGoodsVos[].couponInfoVos[].startTime -优惠券发放时间
 * @param {string|number} params.orderGoodsVos[].couponInfoVos[].endTime -优惠券结束时间
 * @param {number}        params.orderGoodsVos[].couponInfoVos[].count - 优惠券数量
 * @return {Promise<*>}
 */
