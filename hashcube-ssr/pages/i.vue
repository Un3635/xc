        ...
        <div class="page-container">
          <div class="page-container__inner">
            <div class="page-component__nav">
              ...
              <nuxt-link class="nav-link" to="/i/account" active-class="active">我的账户</nuxt-link>
              <nuxt-link class="nav-link" to="/i/order" active-class="active">我的订单</nuxt-link>
              <nuxt-link class="nav-link" to="/i/trust" active-class="active">我的托管</nuxt-link>
              <nuxt-link class="nav-link" to="/i/power" active-class="active">我的云算力</nuxt-link>
              <nuxt-link class="nav-link" to="/i/coupon" active-class="active">我的优惠券</nuxt-link>
              <nuxt-link class="nav-link" to="/i/invitation" active-class="active">我的邀请</nuxt-link>
              <nuxt-link class="nav-link" to="/i/address" active-class="active">收货地址</nuxt-link>
              <nuxt-link class="nav-link" to="/i/safety" active-class="active">安全中心</nuxt-link>
            </div>
