  ...
  <div class="page">
    <div class="page-container">
      <div class="text-right">
        <nuxt-link to="/sign-up" class="link">没有账号，立即注册 &gt;</nuxt-link>
      </div>
          ...
          <div class="x-tabs__content">
            <div class="tabs-pane" v-if="isPhoneLogin">
              ...
              <form class="login-form" v-if="!isPwdLogin">
                ...
                <div class="input-group">
                  <x-captcha v-model="loginForm.captcha" @ready="captchaInstance=$event"/>
                </div>
                <div class="input-group">
                ...
                <el-row class="extra">
                  ...
                  <el-col :span="12" class="text-right">
                    <nuxt-link to="/sign-back">忘记密码?</nuxt-link>
                  </el-col>
                </el-row>
              </form>
              <!-- 手机密码登录 -->
              <form class="login-form email-login" v-if="isPwdLogin">
                ...
                <div class="input-group">
                  <x-captcha v-model="loginForm.captcha" :key="'pwdLogin.captcha'" @ready="captchaInstance=$event"/>
                </div>
                <div class="text-left">
            ...
            <div class="tabs-pane" v-if="!isPhoneLogin">
              ...
              <form class="login-form email-login">
                ...
                <div class="input-group">
                  <el-input type="password" name="password" placeholder="密码(8-18位包含字母与数字)"
                            v-model="loginForm.emailPwd"
                ...
                <div class="input-group">
                  <x-captcha v-model="loginForm.captcha" :key="'emailLogin.captcha'" @ready="captchaInstance=$event"/>
                </div>
                <div class="text-left">
                  <el-checkbox class="remember" v-model="isRememberPwd">记住密码</el-checkbox>
                </div>
...
<script>
  ...
  import {getStore, removeStore, setStore, toPromise} from '../utils';
    ...
    methods: {
      ...
      loginByPhone() {
        ...
        this.$validator.validateAll('$phone')
          ...
          .then(() => SignAPI.phoneLogin(countryCode, phone, code, inviteCode, codeToken, firChannelId, secChannelId))
      ...
      loginByPwd() {
        ...
        this.$validator.validateAll('$phonePwd')
          ...
          .then(() => SignAPI.pwdLogin(phone, password, captcha, firChannelId, secChannelId))
          .then((res) => {
      ...
      emailLogin() {
        ...
        this.$validator.validateAll('$email')
          ...
          .then(() => SignAPI.pwdLogin(email, emailPwd, captcha, firChannelId, secChannelId))
          .then((res) => {
            this.loginSuccessHandler(res);
            this.remEmailPwd();
          })
