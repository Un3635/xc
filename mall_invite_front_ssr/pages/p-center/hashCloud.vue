<template>
    <div class="hashCloud">
        <div class="page-title">
            <p class="txt">我的云算力</p>
            <p class="tip" @click="$router.push('/p-center/hashRepertory')">算力明细</p>
        </div>
        <div class="total">
            <div class="item-left">
                <div class="left-wrap">
        ...
        <div class="cloud-list">
            <div class="table-content">
                <nuxt-child :resData="resData" :pageData = "pageData" @currentChangePage="currentChangePageHandle" ></nuxt-child>
            </div>
        </div>
    </div>
</template>
