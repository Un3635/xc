<template>
  <div class="page">
    ...
    <div class="hash" v-if="recommendHashGoodsList.length>0">
      <div class="inner">
        <swiper class="hash-swiper" :options="swiperOption">
          <swiper-slide class="hash-swiper-slide" style="width: 370px;"
    ...
    <div class="cloud">
      <div class="inner">
        <h2 class="c-headline"><span class="underscore h13">HC云算力</span></h2>
        <p class="c-subhead">
          <span>买币不如买算力</span>
          <span>轻松方便躺着赚</span>
          <span>不定期活动买就送</span>
...
<script>
  ...
  import {deleteLast, last} from '../../plugins/utils';
