    ...
    methods: {
      phoneRegister() {
        ...
        this.$validator.validateAll('$phone')
          ...
          .then(() => SignAPI.register(this.countryCode, phone, password, code, codeToken, inviteCode))
      ...
      sendEmailRegCode() {
        ...
        this.$validator.validate('email', email, '$email')
          .then(toPromise)
          .then(() => {
            if (captcha) {
              return captcha;
      ...
      emailRegister() {
        ...
        this.$validator.validateAll('$email')
          .then(toPromise)
          .then(() => SignAPI.register('', email, password, code, codeToken, inviteCode))
          .then(res => this.regSuccessHandler(res))
          .catch(err => this.errorHandler(err));
      },
