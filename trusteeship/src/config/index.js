...
let shareLink = window.location.origin + '/static/h5/register.html?inviteCode=';
...
const AppConfig = {
  ...
  awardList: 'api/invite/getAwardOrderList',
  ...
  getPoolStatus: 'api/otherPool/getPoolStatus',
  getShareAllPoolStatus: 'api/otherPool/getShareAllPoolStatus',
  getShareAllPoolStatusByCoin: 'api/otherPool/getShareAllPoolStatusByCoin',
  getShareBlockInfo: 'api/otherPool/getShareBlockInfo',
