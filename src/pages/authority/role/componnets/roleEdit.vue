        ...
        <div class="role-edit">
            <el-card class="box-card account-box-card" shadow="hover">
                <!--<div class="detail-item">
                    ...
                    <span class="txt">
                        <el-input :placeholder="role.name" v-model="role.name" clearable></el-input>
                    </span>
                </div>
                <div class="detail-item">
                    <span class="tit">角色名称:</span>
                    <span class="txt">
                        <el-input :placeholder="role.displayName" v-model="role.displayName" clearable></el-input>
                    </span>
                </div>
                <div class="detail-item">
                    <span class="tit">备注:</span>
                    <span class="txt">
                         <el-input :placeholder="role.description" v-model="role.description" clearable></el-input>
                    </span>
                </div>
                <div class="detail-item">
                    ...
                    <span>
                        ...
                        <el-radio v-model="radioStatus" label="停用">停用</el-radio>
                    </span>
                </div>
                <div class="detail-item">
                    <span class="tit"></span>
                    <span>
                        <el-button type="primary" @click="getRoleEdit">确定</el-button>
                ...
                <el-form :model="role" :rules="rules" ref="role" label-width="140px" class="account-ruleForm">
                    ...
                    <el-form-item>
                        <el-button type="primary" @click="getRoleEdit" :loading="submitLoading">确定</el-button>
                        <el-button type="primary" @click="resetData" plain>重置</el-button>
                    </el-form-item>
                </el-form>
            </el-card>
  ...
  export default {
    ...
    methods:{
      ...
      resetData(){
        ...
        this.role.displayName = this.$route.params.displayName;
        this.role.name = this.$route.params.name;
        this.role.description = this.$route.params.description;
        this.radioStatus = this.$route.params.status;
      }
    },
    mounted(){
      this.resetData() //重置数据
