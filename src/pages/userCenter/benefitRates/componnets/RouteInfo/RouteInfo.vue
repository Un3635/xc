...
<script>
  ...
  export default {
    ...
    methods: {
       ...
       getTableData(){
          let vm = this;
          this.axiosGET(vm, vm.$API.API.benefitRate,
       ...
       setTableData(_data){
          ...
          for (let i = 0; i <_data.length; i++) {
            let obj = {};
            obj.mid = _data[i].mid;
            obj.incomeLevel = _data[i].incomeLevel;
            obj.incomeGemstone = _data[i].incomeGemstone ? _data[i].incomeGemstone : '-';
            obj.holdGemstone = _data[i].holdGemstone ? _data[i].holdGemstone : '-';
            myData[i] = obj;
          }
       ...
       handleDetail(index, row) {
        this.$router.push({path: '/userCenter/benefitRates/benefitRateDetail', query: {mid: row.mid}})
       },
    },
    mounted(){
      this.getTableData();
