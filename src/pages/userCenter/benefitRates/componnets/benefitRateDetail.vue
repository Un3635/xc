        ...
        <div class="detail"
            ...
            <div class="title-box">
                ...
                <el-form label-width="150px" class="rule-form">
                    ...
                    <el-form-item label="收益等级：">
                        <span class="detail-info">{{formData.incomeLevel}}</span>
                    </el-form-item>
                    <el-form-item label="累计收入宝石：">
                        <span class="detail-info">{{formData.incomeGemstone}}</span>
                    </el-form-item>
                    <el-form-item label="当前持有宝石：">
                        <span class="detail-info">{{formData.holdGemstone}}</span>
                    </el-form-item>
                    <el-form-item style="height:0;margin:0;"></el-form-item>
                </el-form>
            </div>
            <div class="title-box" style="margin-top:50px;">
                <div class="title-txt">收益记录</div>
                <el-table
                        :data="tableData"
                        class="record-table"
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      getFormData(){
        let vm = this;
        this.axiosGET(vm, vm.$API.API.benefitRateDetail+vm.mid,
      ...
      setFormData(_data){
        ...
        obj.holdGemstone = _data.holdGemstone ?  _data.holdGemstone : '-';
        obj.incomeGemstone = _data.incomeGemstone ? _data.incomeGemstone : '-';
        obj.incomeLevel = _data.incomeLevel ? _data.incomeLevel : '-';
        this.formData = obj;
      },
      getTableData(){
        let vm = this;
