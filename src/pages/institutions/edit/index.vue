    ...
    <d2-container>
        ...
        <div class="detail"
            ...
            <el-form :model="paramsData" :rules="rules" ref="paramsForm" label-width="150px" class="rule-form">
                ...
                <el-form-item label="机构收益：" prop="agencyReward" >
  ...
  export default {
    ...
    methods:{
      ...
      setTableData(_data){
          ...
          this.paramsData.agencyReward =  Math.round(_data.agencyReward*100);
          this.paramsData.remark =  _data.remark;
      ...
      submitForm(formName){
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            this.axiosPOST(vm, vm.$API.API.signEdit,
              'application/x-www-form-urlencoded',
              vm.paramsData,
