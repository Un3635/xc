 ...
 * @param {string}  pageSize    页数大小* @returns {Promise<*>}
 */
...
const CurrencyType = () => TokenAPI.getValid().then(token => api.$get(AppConfig.currencyType, {params: {token}}, AppConfig.apiEndpoint2));
