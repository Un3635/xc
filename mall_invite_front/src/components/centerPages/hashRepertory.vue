            ...
            <div v-if="activeName === activeCon">
                <ul class="product-list">
                    <li class="product-item" v-for="(item,index) in computingList" :key="index">
                        <ul class="p-tit">
                            <li class="tit-item"><span>订单号</span> <span>{{item.id}}</span></li>
                            <li class="tit-item">
                        ...
                        <ul class="p-info">
                            <li><img :src="item.imgUrl"/><span>{{item.name}}</span>
                            </li>
...
export default {
  ...
  methods: {
    ...
    getComputingDetailDatas() {
      ...
      var vm = this;
      // console.log(API.getComputingDetail, 'API.getComputingDetail is');
