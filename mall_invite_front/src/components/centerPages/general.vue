    ...
    <div class="general">
        ...
        <ul class="general-list">
            <li class="general-item">
                ...
                <ul class="item-info">
                    <li class="info-li">
                        <p><span class="p-tit">用户名</span> <span class="p-txt">{{outUserInfo.username}}</span><br/>
                            <span class="p-tit">手机号</span> <span class="p-txt">{{outUserInfo.phoneNo}}</span></p>
                    </li>
                    <li class="line-li">
                        <div class="line-mid"></div>
                    </li>
                    <li class="info-li">
                        <p><span class="p-tit">谷歌验证器</span>
                            <span class="p-default">{{isGaSecret}}</span>
                            <br/>
                            <span class="p-tit">用户等级</span> <span class="p-txt">{{outUserInfo.userLevel}}</span></p>
                    </li>
                    <li class="line-li">
                        <div class="line-mid"></div>
                    </li>
                    <li class="info-li">
                        <p><span class="p-tit">注册时间</span> <span class="p-txt">{{outUserInfo.registTime | date('YYYY-MM-DD')}}</span><br/>
                            <span class="p-tit">钱包地址</span>
                            <span class="currency" @click="turnToAdd">
                                <span class="p-currency">BTC</span>
                                <span class="p-currency">LTC</span>
            ...
            <li class="general-item">
                <div class="tit">
                    ...
                    <div class="recharge">
                        ...
                        <span @click="$router.push('/center/account')">提币</span>
                    </div>
                </div>
                    ...
                    <div class="item-left item-left2">
                        <div class="left-wrap">
                            <ul class="carousel carousel-income">
                                <li class="carousel-item"
                                    v-for="item in outMyIncomeVo.outCoinInfoVos"
                                    v-show="item.holdingAmount || item.preFrozen">
                                    <p class="p1">{{item.coinName}}</p>
                                    <h3>{{item.holdingAmount}}</h3>
            ...
            <li class="general-item">
                ...
                <div class="item-detail">
                    ...
                    <div class="more" v-if="cloudOutRevenueDetailsList && cloudOutRevenueDetailsList.length >2"><p @click="$router.push('/center/hash')">查看更多</p></div>
                </div>
            </li>
            <!--量化收益详情-->
            <li class="general-item">
                ...
                <div class="item-detail">
                    ...
                    <div class="more" v-if="quantificateOutRevenueDetailsList && quantificateOutRevenueDetailsList.length > 2" ><p @click="$router.push('/center/income')">查看更多</p></div>
                </div>
            </li>
            <li class="general-item">
                <div class="tit">
                ...
                <ul class="item-promote">
                    <li class="item-li">
                        ...
                        <div class="right">
                            ...
                            <span class="copy-btn"
                                  @click="doCopy(outSpreadIncome.spreadLink)">复制</span>
                        </div>
                    </li>
                    <li class="item-li">
                        <div class="left">推广链接</div>
                        <div class="right">
                            ...
                            <span class="copy-btn"
                                  @click="doCopy(outSpreadIncome.inviteCode)">复制</span>
                        </div>
                    </li>
                </ul>
            </li>
            <li class="general-item">
                ...
                <div class="item-detail">
                    ...
                    <div class="more" v-if="outSpreadRewardList && outSpreadRewardList.length>2"><p @click="$router.push('/center/invite')">查看更多</p></div>
                </div>
            </li>
        </ul>
    </div>
...
<script>
    ...
    methods: {
      ...
      getAccountData() {
        var vm = this;
        getajaxdata(API.accountOverviewInfo, 'POST', '', 'JSON', function (res) {
          if (res.code == '1000') {
            ...
            vm.cloudOutRevenueDetailsList = res.data.cloudOutRevenueDetailsList.slice(0, 3);//云算力收益详情数据
            vm.quantificateOutRevenueDetailsList = res.data.quantificateOutRevenueDetailsList; //量化收益详情数据
            let str = res.data.outMyAccount.totalAssets.toString();
            vm.totalAmount = str.substring(0, str.length - 6);
      ...
      initTableData(tab, list) {
        ...
        this.$nextTick(function () {
          ...
          this.cloudOutRevenueDetailsList = tab;
      ...
      initTableData2(tab, list) {
        ...
        this.$nextTick(function () {
          this.quantificateOutRevenueDetailsList = tab.slice(0,3);
      ...
      turnToAdd(){
          this.$router.push({path: '/center/profile',query: {section: 'getMoney'}})
      }
    },
    mounted() {
      if (localStorage.getItem('userInfo')) {
        var userInfo = JSON.parse(localStorage.getItem('userInfo'));
        this.isGaSecret = Boolean(userInfo.isGaSecret) ? '已绑定' : '未绑定';
      }
      this.getAccountData();
